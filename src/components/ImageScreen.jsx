    ...
    return (
        <div className=" flex flex-col mt-10 pt-10 w-full h-full">
            ...
            <div className=" mt-5 w-full px-40 flex gap-3 justify-center items-center">
                <img width={80} src={imageInfo.image} alt="img1" className=" outline outline-2 outline-purple-900 cursor-pointer" />
                <img width={80} src={imageInfo.image} alt="img2" className="cursor-pointer" />
                <img width={80} src={imageInfo.image} alt="img3" className="cursor-pointer" />
                <img width={80} src={imageInfo.image} alt="img4" className="cursor-pointer" />
                <img width={80} src={imageInfo.image} alt="img5" className="cursor-pointer" />
